        ...
        <div className="scroll-content">
          <motion.div
            ...
            style={{
              ...
              background:
                'linear-gradient(90deg, rgba(41,98,255,0.18) 0%, rgba(139,92,246,0.13) 100%)',
              borderRadius: 20,
              boxShadow: '0 2px 24px 0 #1e293b44',
              padding: '1.5rem 2rem',
              display: 'flex',
              alignItems: 'center',
              ...
              gap: 24,
              flexWrap: 'wrap',
              border: '1.5px solid rgba(41,98,255,0.18)',
            ...
            <div
              ...
              <span style={{ fontSize: 26, color: '#82b1ff', marginRight: 8 }}>📊</span>Статистика
              сервиса
              <div style={{ fontWeight: 400, fontSize: 15, color: '#a5b4fc', marginTop: 6 }}>
                Следите за ростом пользователей и развитием Pesherkino VPN в реальном времени
              </div>
            </div>
            <motion.button
              className="download-button"
