          ...
          <motion.div
            ...
            <div
              ...
              <div
                ...
                Изучите статистику сервиса и получите подробную документацию для максимально
            ...
            <div
              ...
              <motion.button
                ...
                whileHover={{
                  ...
                  background:
                    'linear-gradient(135deg, rgba(59,130,246,0.3), rgba(59,130,246,0.25))',
                  color: '#fff',
                  borderColor: '#60a5fa',
                }}
                whileTap={{ scale: 0.98 }}
              ...
              <motion.button
                ...
                style={{
                  ...
                  fontWeight: 600,
                  background:
                    'linear-gradient(135deg, rgba(139,92,246,0.2), rgba(139,92,246,0.15))',
                  color: '#e2e8f0',
                ...
                whileHover={{
                  ...
                  background:
                    'linear-gradient(135deg, rgba(139,92,246,0.3), rgba(139,92,246,0.25))',
                  color: '#fff',
                  borderColor: '#a855f7',
                }}
                whileTap={{ scale: 0.98 }}
