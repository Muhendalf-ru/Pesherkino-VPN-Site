...
const DownloadButtons: React.FC<DownloadButtonsProps> = ({ onAppDownload, onShowAppGuide }) => {
    ...
    <div className="button-container">
      ...
      <div className="browser-button-wrapper">
        ...
        <motion.button
          ...
          whileHover={{ scale: 1.05 }}
          whileTap={{ scale: 0.95 }}
          onClick={() => window.open('https://t.me/pesherkino_bot?start=ref_855347094', '_blank')}>
          <span>Купить VPN</span>
          <svg className="telegram-icon" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 50 50">
            <path
